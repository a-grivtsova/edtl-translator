...
public class EdtlParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, EdtlGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getModelAccess().getAbbrsAssignment_2(), "rule__Model__AbbrsAssignment_2");
			builder.put(grammarAccess.getModelAccess().getMacrosesAssignment_3(), "rule__Model__MacrosesAssignment_3");
			builder.put(grammarAccess.getModelAccess().getReqsAssignment_4(), "rule__Model__ReqsAssignment_4");
			...
			builder.put(grammarAccess.getRequirementAccess().getNlTrigAssignment_2_4_2(), "rule__Requirement__NlTrigAssignment_2_4_2");
			builder.put(grammarAccess.getRequirementAccess().getInvExprAssignment_3_2(), "rule__Requirement__InvExprAssignment_3_2");
			builder.put(grammarAccess.getRequirementAccess().getNlInvAssignment_3_4_2(), "rule__Requirement__NlInvAssignment_3_4_2");
			builder.put(grammarAccess.getRequirementAccess().getFinalExprAssignment_4_2(), "rule__Requirement__FinalExprAssignment_4_2");
			builder.put(grammarAccess.getRequirementAccess().getNlFinalAssignment_4_4_2(), "rule__Requirement__NlFinalAssignment_4_4_2");
			builder.put(grammarAccess.getRequirementAccess().getDelayExprAssignment_5_2(), "rule__Requirement__DelayExprAssignment_5_2");
			builder.put(grammarAccess.getRequirementAccess().getNlDelayAssignment_5_4_2(), "rule__Requirement__NlDelayAssignment_5_4_2");
			builder.put(grammarAccess.getRequirementAccess().getReacExprAssignment_6_2(), "rule__Requirement__ReacExprAssignment_6_2");
			builder.put(grammarAccess.getRequirementAccess().getNlReacAssignment_6_4_2(), "rule__Requirement__NlReacAssignment_6_4_2");
			builder.put(grammarAccess.getRequirementAccess().getRelExprAssignment_7_2(), "rule__Requirement__RelExprAssignment_7_2");
			builder.put(grammarAccess.getRequirementAccess().getNlRelAssignment_7_4_2(), "rule__Requirement__NlRelAssignment_7_4_2");
