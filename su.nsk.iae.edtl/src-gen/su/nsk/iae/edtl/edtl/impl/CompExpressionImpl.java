 ...
 * </p>
 * <ul>
 *   <li>{@link su.nsk.iae.edtl.edtl.impl.CompExpressionImpl#getCompOp <em>Comp Op</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CompExpressionImpl extends AndExpressionImpl implements CompExpression
{
  ...
  {
    return EdtlPackage.Literals.COMP_EXPRESSION;
  }
  ...
  public void setCompOp(CompOperator newCompOp)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EdtlPackage.COMP_EXPRESSION__COMP_OP, oldCompOp, compOp));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EdtlPackage.COMP_EXPRESSION__COMP_OP:
        return getCompOp();
    }
