 ...
 * </p>
 * <ul>
 *   <li>{@link su.nsk.iae.edtl.edtl.impl.wImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class wImpl extends ModelImpl implements w
{
  /**
  ...
  public EList<Statement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<Statement>(Statement.class, this, EdtlPackage.W__ELEMENTS);
    }
    return elements;
  }
