 ...
 * </p>
 * <ul>
 *   <li>{@link su.nsk.iae.edtl.edtl.impl.UnExpressionImpl#getUnOp <em>Un Op</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnExpressionImpl extends EquExpressionImpl implements UnExpression
{
  ...
  {
    return EdtlPackage.Literals.UN_EXPRESSION;
  }
  ...
  public void setUnOp(String newUnOp)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EdtlPackage.UN_EXPRESSION__UN_OP, oldUnOp, unOp));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EdtlPackage.UN_EXPRESSION__UN_OP:
        return getUnOp();
    }
